...
```javascript
mt19937 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-mt19937@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-base-mt19937@umd/bundle.js"></script>
```
